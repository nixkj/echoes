...
echo "7.3.4" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 7.3.4 → 7.3.5 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 7.3.4 → 7.3.5) |
| `./build.sh version minor` | Increment minor version (e.g. 7.3.4 → 7.4.0) |
| `./build.sh version major` | Increment major version (e.g. 7.3.4 → 8.0.0) |
...
I (580) MAIN: Firmware Version: 7.3.4
I (584) MAIN: ========================================
