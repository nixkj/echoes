...
```bash
./build.sh version patch     # 7.0.8 → 7.0.9 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 7.0.8 → 7.0.9) |
| `./build.sh version minor` | Increment minor version (e.g. 7.0.8 → 7.1.0) |
| `./build.sh version major` | Increment major version (e.g. 7.0.8 → 8.0.0) |
...
I (580) MAIN: Firmware Version: 7.0.8
I (584) MAIN: ========================================
