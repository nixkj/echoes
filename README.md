...
```bash
./build.sh version patch     # 7.1.7 → 7.1.8 (updates FIRMWARE_VERSION in main/ota.h)
...
idf.py build
cp build/echoes.bin /opt/echoes/firmware/echoes.bin
echo "7.1.7" > /opt/echoes/firmware/version.txt
```
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 7.1.7 → 7.1.8) |
| `./build.sh version minor` | Increment minor version (e.g. 7.1.7 → 7.2.0) |
| `./build.sh version major` | Increment major version (e.g. 7.1.7 → 8.0.0) |
...
I (580) MAIN: Firmware Version: 7.1.7
I (584) MAIN: ========================================
