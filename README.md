...
echo "7.2.3" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 7.2.3 → 7.2.4 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 7.2.3 → 7.2.4) |
| `./build.sh version minor` | Increment minor version (e.g. 7.2.3 → 7.3.0) |
| `./build.sh version major` | Increment major version (e.g. 7.2.3 → 8.0.0) |
...
I (580) MAIN: Firmware Version: 7.2.3
I (584) MAIN: ========================================
