...
echo "6.4.2" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 6.4.2 → 6.4.3 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 6.4.2 → 6.4.3) |
| `./build.sh version minor` | Increment minor version (e.g. 6.4.2 → 6.5.0) |
...
I (580) MAIN: Firmware Version: 6.3.0
I (584) MAIN: ========================================
