...
echo "7.5.2" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 7.5.2 → 7.5.3 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 7.5.2 → 7.5.3) |
| `./build.sh version minor` | Increment minor version (e.g. 7.5.2 → 7.6.0) |
| `./build.sh version major` | Increment major version (e.g. 7.5.2 → 8.0.0) |
...
I (580) MAIN: Firmware Version: 7.5.2
I (584) MAIN: ========================================
