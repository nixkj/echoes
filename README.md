...
echo "6.4.7" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 6.4.7 → 6.4.8 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 6.4.7 → 6.4.7) |
| `./build.sh version minor` | Increment minor version (e.g. 6.4.7 → 6.5.0) |
...
I (580) MAIN: Firmware Version: 6.4.7
I (584) MAIN: ========================================
