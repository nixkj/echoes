...
echo "6.5.5" > /opt/echoes/firmware/version.txt
```
...
```bash
./build.sh version patch     # 6.5.5 → 6.5.6 (updates FIRMWARE_VERSION in main/ota.h)
...
| `./build.sh version patch` | Increment patch version in `main/ota.h` (e.g. 6.5.5 → 6.5.6) |
| `./build.sh version minor` | Increment minor version (e.g. 6.5.5 → 6.6.0) |
...
I (580) MAIN: Firmware Version: 6.5.5
I (584) MAIN: ========================================
...
- Force Wi-Fi reconnect if dropped
