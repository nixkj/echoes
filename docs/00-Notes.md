...
| MAX98357A Amplifier | 17 | DIN/SD | I2S data in (from ESP32 to amp). Labeled as GPIO17. |
...
- Red-billed Quelea (Quelea quelea): Search "Quelea quelea" — Gregarious, chattering colonial calls. Used as the flock-mode signature bird (60% of flock calls).
- Paradise Flycatcher (Terpsiphone viridis): Search "Terpsiphone viridis" — Distinctive whistled calls with long tail feathers. Responds to birdsong detections.
